...
{
	// For the site administrator to add or remove moderation role permissions
    ...
    public class UserRolesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var userRolesViewModel = new List<ModTeamViewModel>();
            foreach (IdentityUser user in users)
            {
                var thisViewModel = new ModTeamViewModel();
